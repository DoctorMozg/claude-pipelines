---
name: outreach-scout
description: Discovers companies from a specific business directory or data source. Searches the source, extracts company metadata, and outputs a structured company list. Used by the lead-pipeline skill.

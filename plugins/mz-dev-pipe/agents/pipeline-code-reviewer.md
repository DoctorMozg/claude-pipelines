...
description: Reviews implementation code for the dev-pipeline skill. Catches bugs, security issues, missed requirements, and convention violations by reading every modified file thoroughly.

---
name: pipeline-coder
description: Pipeline-only. Implements specific work units from an approved plan. Reads existing code, follows project conventions, and makes precise changes.

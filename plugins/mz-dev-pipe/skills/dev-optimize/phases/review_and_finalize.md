...
Full detail for the review, rejection-handling, and finalization phases of the dev-optimize skill. Covers dispatching mirrored reviewers per chunk, respawning optimizers on rejection, and writing the final summary.
...
```
Review the optimization applied to one chunk of a larger dev-optimize pass.

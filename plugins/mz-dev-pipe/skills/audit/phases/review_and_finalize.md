...
Full detail for the review, rejection-handling, regression-testing, and finalization phases of the audit skill. Covers dispatching mirrored reviewers per chunk, selective re-dispatch of rejected chunks, writing regression tests for critical/high severity fixes, and producing the final summary.
...
```
Review the fixes applied to one chunk of a larger audit pass.
...
Consider running audit again with lens-specific focus to address these.

...
- **Parallel write conflict**: should not happen since chunking is by affected file, but if a coder reports cross-file edits (similar to optimize's cross-scope exception), detect and sequentialize in the next iteration.

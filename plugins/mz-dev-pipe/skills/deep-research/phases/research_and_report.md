...
## Step 2: Dispatch parallel pipeline-web-researcher agents

For each subtopic, launch a `pipeline-web-researcher` agent **in parallel** with a detailed prompt. Each agent's prompt must include:
...
- Number of pipeline-web-researcher agents dispatched: N
